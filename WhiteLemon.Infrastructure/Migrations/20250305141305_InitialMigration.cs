    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendship", x => new { x.RequesterId, x.RequestedId });
                    table.ForeignKey(
                        name: "FK_Friendship_Users_RequestedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendship_RequestedId_RequesterId",
                table: "Friendship",
                columns: new[] { "RequestedId", "RequesterId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Friendship_RequesterId_RequestedId",
                table: "Friendship",
